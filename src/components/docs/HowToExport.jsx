  ...
  return (
    <div className="flex flex-col mx-auto px-4 py-8 max-w-4xl font-inter">
      ...
      <div className="text-sm max-w-none">
        <p className="mb-4">
          This guide will walk you through the steps to integrate the Limeblock
          chat widget into your project. Follow these instructions to get your
          AI-powered chat widget up and running in no time.
        </p>
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
          <p className="text-yellow-700">
            <strong>Important:</strong> Never expose your API key in client-side
            code in production. Consider using environment variables and
        ...
        <p className="mb-4">
          Context parameters help personalize the chat experience by providing
          additional information like user ID, board ID, or any custom
          parameters your implementation requires.
        </p>
        ...
        <p className="mb-4">
          Here's a complete example of implementing the Limeblock chat widget in
          a React component:
        </p>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            ...
            <p>
              Ensure you are using # in your hex codes and that you hit the save
              button
            </p>
          </div>
        </div>
