  ...
  return (
    <div className="flex-1 overflow-auto">
      <div className="flex flex-col mx-auto px-4 py-8 max-w-4xl font-inter">
        ...
        <h1 className="text-4xl font-aeonik font-medium mb-8">Report a Bug</h1>

        <div className="text-sm max-w-none">
          <p className="mb-4">
            If you think you found a bug or vulnerability within Limeblock,
            please contact our founder through{" "}
